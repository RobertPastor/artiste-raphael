...
16:50 ~/artiste-raphael (master)$ . .virtualEnv/bin/activate
(.virtualEnv) 16:53 ~/artiste-raphael (master)$ 
(.virtualEnv) 16:53 ~/artiste-raphael (master)$ 
(.virtualEnv) 16:53 ~/artiste-raphael (master)$ 
...
(.virtualEnv) 16:53 ~/artiste-raphael (master)$ pip install flask
...
(.virtualEnv) 16:55 ~/artiste-raphael (master)$ 